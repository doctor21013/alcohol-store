...
public class AuthController {
    ...
    public String showRegistrationForm() {
        return "register"; // имя вашего HTML-шаблона
    }
    ...
    public String registerUser(@RequestParam String username,
        ...
        newUser.setIsAdmin(false); // По умолчанию обычный пользователь

        userRepository.save(newUser);

        // 4. Перенаправляем на страницу входа с сообщением об успехе
